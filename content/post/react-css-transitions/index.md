---
Title: "Easy React Animations via CSS Transitions"
Date: 2019-03-03
...
![Heart - A CSS art](./css-heart.png)

CSS art by Dennis Harry | https://css-heart-animations.netlify.com/
...
Which means that you can't use CSS Transitions on [conditionally rendered](https://reactjs.org/docs/conditional-rendering.html) React elements. Also, you can't use CSS transitions to animate *mounting* and *unmounting* of React elements.
